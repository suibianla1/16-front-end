                            ...
                            <div class="form-box address-info">
                                <dl class="form-group">
                                    ...
                                    <dd>
                                        ...
                                        <input name="accept_name" id="accept_name" type="text" class="input" v-mmodel="form.accept_name" datatype="s2-20" sucmsg="">
                                ...
                                <dl class="form-group">
                                    <dt>详细地址：</dt>
                                    <dd>
                                        <input name="address" id="address" type="text" class="input" v-model="form.address" datatype="*2-100" sucmsg=" ">
                                ...
                                <dl class="form-group">
                                    <dt>手机号码：</dt>
                                    <dd>
                                        <input name="mobile" id="mobile" type="text" class="input" v-model="form.mobile" datatype="m" sucmsg=" ">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="8" cellspacing="0" class="cart-table">
                                <tbody>
                                    ...
                                    <tr v-for="item in orderData" :key="item.id">
                                        <td width="68">
                                            <router-link target="_blank" :to="{name:'goodsdetail', params:{id:id}}">
...
export default {
    ...
    methods: {
        getOrder(){
            this.$axios.get(this.$api.orderList + this.id).then(res=>{
