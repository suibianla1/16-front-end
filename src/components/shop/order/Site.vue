                            ...
                            <div class="form-box address-info">
                                <dl class="form-group">
                                    ...
                                    <dd>
                                        ...
                                        <input  name="accept_name" id="accept_name" type="text" class="input" datatype="s2-20" sucmsg=" " v-model="form.accept_name">
                                ...
                                <dl class="form-group">
                                    <dt>详细地址：</dt>
                                    <dd>
                                        <input name="address" id="address" type="text" class="input" datatype="*2-100" sucmsg=" " v-model="form.address">
                                ...
                                <dl class="form-group">
                                    <dt>手机号码：</dt>
                                    <dd>
                                        <input name="mobile" id="mobile" type="text" class="input" datatype="m" sucmsg=" " v-model="form.mobile">
                                ...
                                <dl class="form-group">
                                    <dt>电子邮箱：</dt>
                                    <dd>
                                        <input name="email" id="email" type="text" class="input" value="" v-model="form.email">
                                ...
                                <dl class="form-group">
                                    <dt>邮政编码：</dt>
                                    <dd>
                                        <input name="post_code" id="post_code" type="txt" class="input code" v-model='form.post_code'>
...
<script>
    export default {
        ...
        methods: {
            getGoodsList(){
                this.$axios.get(this.$api.orderList + this.ids).then(res=>{
